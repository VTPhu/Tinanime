			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9 add-block col-sm-9">
						<a href="#"><img src="images/bannerasm-01.png" alt="adds" /></a>
					</div>
				</div>
			</div><!-- container /- -->
		</div><!-- logo-add-block /- -->
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-collapse collapse" id="navbar" >
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="" class="" data-toggle=""><i class="fa fa-home"></i></a>
                                    
                                </li>
                                <li class="dropdown active">
                                    <a href="/" class="dropdown-toggle">Tất cả tin</a>
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle">Thể loại</a>
                                    <ul id="data" class="dropdown-menu" role="menu">
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="/login" class="dropdown-toggle">Đăng nhập</a>
                                </li>
                                <li class="dropdown">
                            ...
                            @if(Auth::check())
		                    <p style="color:#fff;float:left;padding-top:27px;" >Chào mừng: {{Auth::user()->email}}</p>
				            <button  style="background-color:#FD8C67;border:none;"><a style="color:white;text-decoration:none;font-size:50px;" href="{{ Auth::logout() }}"><i class="fa fa-sign-out"></i></a></button>	
		                     @endif
                            </div>
